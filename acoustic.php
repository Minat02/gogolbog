...
<head>
    ...
    <title>Акустические гитары</title>
</head>
<body class="body">
<style>
</style>
...
<hr>
<h1 class="h">Акустические гитары</h1>
<div class="conte">
<?php
require_once('db.php');
$sql = "SELECT * FROM tovar WHERE Category = 'Acoustic'";
        ...
        <?php foreach ($products as $product): ?>
            ...
            <div class="hui">
                ...
                <form action="trash.php" method="POST">
                    ...
                    <button type="submit" class="zak">Добавить в корзину</button>
                </form>
                </div>
            </li>
        <?php endforeach; ?>
